        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-12 col-12">
                    ...
                    <h2 class="mb-2"><i class="bi bi-gear-fill"></i> Unsur SKM</h2>
                        ...
                        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form action="<?= base_url() ?>admin/master/unsur_skm/simpan" method="post">
                                        <div class="modal-body">
                                            <div class="form-group mb-2">
                                                <label for="unsur">Unsur SKM</label>
                                                <input type="text" name="unsur" id="unsur" class="form-control">
                                            </div>
                                            <div class="form-group mb-2">
                                                <label for="nilai">Nilai Unsur</label>
